...
p1 <- ggplot(days_since, aes(x=days_since_2011, y = results$days_since_2011)) + geom_line() + geom_rug(alpha=0.1, sides="b") + xlab("Days since 2011") + ylab("Prediction") + scale_y_continuous(limits = c(2500,6000))
p2 <- ggplot(days_since, aes(x=temp, y = results$temp)) + geom_line() + geom_rug(alpha=0.1, sides="b") + xlab("Temperature") + scale_y_continuous(limits = c(2500,6000)) 
p3 <- ggplot(days_since, aes(x=hum , y = results$hum)) + geom_line() + geom_rug(alpha=0.1, sides="b") + xlab("Humidity") + scale_y_continuous(limits = c(2500,6000)) 
p4 <- ggplot(days_since, aes(x=windspeed, y = results$windspeed)) + geom_line() + geom_rug(alpha=0.1, sides="b") + xlab("Wind speed") + scale_y_continuous(limits = c(2500,6000))
...
p5 = ggplot(th, aes(temp, hum, fill = p)) + geom_tile(width = 40, height = 40) +
